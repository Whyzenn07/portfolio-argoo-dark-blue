...
export default function Footer() {
  ...
  return (
    ...
    >
      <div
        className="grid grid-cols-1 md:grid-cols-[1.8fr_1fr_1fr] gap-[60px] pb-10
                      border-b border-[rgba(0,180,255,0.12)] mb-7 max-w-[1200px] mx-auto"
      >
        {/* Brand */}
        <div
          ref={brand.ref}
          className={`fade-up ${brand.visible ? "visible" : ""}`}
        >
          <button
          ...
          <p className="text-[#64748b] text-[0.88rem] leading-[1.7] mt-[14px] max-w-[280px]">
            Building digital experiences dengan passion dan precision. Mari
        ...
        <div
          ref={links.ref}
          className={`fade-up delay-1 ${links.visible ? "visible" : ""}`}
        >
          <h5 className="font-bold text-[0.9rem] mb-[18px] text-[#e2e8f0]">
            Quick Links
          </h5>
        ...
        <div
          ref={social.ref}
          className={`fade-up delay-2 ${social.visible ? "visible" : ""}`}
        >
          <h5 className="font-bold text-[0.9rem] mb-[18px] text-[#e2e8f0]">
            Get In Touch
          </h5>
          <div className="space-y-[12px]">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-[0.8rem] text-[#22c55e] font-semibold">
                Open to Work
              </span>
            </div>
          </div>
